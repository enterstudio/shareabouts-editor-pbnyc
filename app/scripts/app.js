...
(function(NS, $, console){
  ...
  NS.app.addInitializer(function(options){
    NS.datasetCollection = new Backbone.Collection([
      { id: 'pbnyc-2014', name: 'PBNYC Ideas', url: 'http://data.shareabouts.org/api/v2/pbnyc/datasets/pbnyc-2014', dataUrl: 'http://data.shareabouts.org/api/v2/pbnyc/datasets/pbnyc-2014/places?include_invisible&include_private&page_size=5000&format=csv'}
    ]);
  });
